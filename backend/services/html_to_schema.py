...
from services.design_source.base import DesignTokens
from services.jsx_to_schema import JSXElement, _rewrite_asset_paths, _transform_node
...
def tokens_from_html(html: str) -> DesignTokens:
