...
COMPONENTS: list[dict[str, Any]] = [
    ...
    _c("icon", "Icon", "Content", "A small symbol — next to a word on a button, or on its own",
       search=["symbol", "glyph", "lucide", "star", "check"], types=[],
       jsx='<Star className="h-4 w-4" />', imports=[{"source": "lucide-react", "names": ["Star"]}]),
    _c("image", "Image", "Content", "A picture, uploaded or from a web address",
       ...
       settings=[_s("src", "Picture", "image", {"kind": "prop", "name": "src"}),
