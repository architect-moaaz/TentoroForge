...
NODE_TASKS: dict[str, str] = {
    ...
    "page_details": (
        ...
        "designer: someone deciding whether to borrow a drill wants what it is "
        "and what comes with it, who owns it and whether that person is "
        "verified, how often it has been lent, and what happens at handover if "
        "something is wrong. For each fact give a `label`, the reader's "
        ...
        "the page's record — or, with `of`, at the record it points at (the "
        ...
        "decides: never invent a price, a rating or a deposit the description "
        "does not have, and nothing the business rules forbid."
    ),
    "analytics": (
