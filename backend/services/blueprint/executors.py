...
NODE_TASKS: dict[str, str] = {
    ...
    "analytics": (
        ...
        "of values (an enum, a status, a foreign key) or a bucketed date — "
        "never on a free-text field or an id of the entity itself. A metric "
        ...
        "shares → treemap; a profile over several axes → radar. A split "
