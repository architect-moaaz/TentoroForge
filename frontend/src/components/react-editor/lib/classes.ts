...
export const CLASS_GROUPS: ClassGroup[] = [
  ...
  { key: "lineHeight", label: "Line spacing", test: /^leading-(none|tight|snug|normal|relaxed|loose|\d+)$/,
    options: opt([["leading-tight", "Tight"], ["leading-snug", "Snug"], ["leading-normal", "Normal"], ["leading-relaxed", "Relaxed"], ["leading-loose", "Loose"]]) },
  { key: "letterSpacing", label: "Letter spacing", test: /^tracking-(tighter|tight|normal|wide|wider|widest)$/,
    options: opt([["tracking-tight", "Tight"], ["tracking-normal", "Normal"], ["tracking-wide", "Wide"], ["tracking-widest", "Very wide"]]) },
  { key: "wrap", label: "Long text", test: /^(truncate|whitespace-nowrap|whitespace-normal|line-clamp-(\d+|none))$/,
    options: opt([["whitespace-normal", "Wraps onto new lines"], ["truncate", "Cut off with … on one line"], ["line-clamp-2", "At most two lines"], ["line-clamp-3", "At most three lines"], ["whitespace-nowrap", "Never wraps"]]) },
